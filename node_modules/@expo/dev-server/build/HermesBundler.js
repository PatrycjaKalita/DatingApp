...
exports.getHermesBytecodeBundleVersionAsync = exports.isHermesBytecodeBundleAsync = exports.maybeInconsistentEngineAsync = exports.parseGradleProperties = exports.createHermesSourcemapAsync = exports.buildHermesBundleAsync = exports.isEnableHermesManaged = void 0;
...
function isEnableHermesManaged(expoConfig, platform) {
    ...
    switch (platform) {
        case 'android':
            return ((_a = expoConfig.android) === null || _a === void 0 ? void 0 : _a.jsEngine) === 'hermes';
        default:
            return false;
    }
}
...
async function buildHermesBundleAsync(projectRoot, code, map, optimize = false) {
    ...
    try {
        ...
        const hermesCommand = importMetroFromProject_1.importHermesCommandFromProject(projectRoot);
        const args = ['-emit-binary', '-out', tempHbcFile, tempBundleFile, '-output-source-map'];
        if (optimize) {
            args.push('-O');
        }
        await spawn_async_1.default(hermesCommand, args);
...
async function createHermesSourcemapAsync(projectRoot, sourcemap, hermesMapFile) {
    const composeSourceMaps = importMetroFromProject_1.importMetroSourceMapComposeSourceMapsFromProject(projectRoot);
...
async function maybeInconsistentEngineAsync(projectRoot, platform, isHermesManaged) {
    switch (platform) {
        case 'android':
...
exports.maybeInconsistentEngineAsync = maybeInconsistentEngineAsync;
