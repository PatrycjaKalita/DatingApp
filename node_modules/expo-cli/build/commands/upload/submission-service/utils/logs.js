...
async function displayLogs(submission, status, verbose) {
  ...
  if (status === _SubmissionService().SubmissionStatus.ERRORED && submission !== null && submission !== void 0 && (_submission$submissio = submission.submissionInfo) !== null && _submission$submissio !== void 0 && _submission$submissio.error) {
...
async function downloadAndPrintSubmissionLogs(submission) {
  ...
  if (!((_submission$submissio2 = submission.submissionInfo) !== null && _submission$submissio2 !== void 0 && _submission$submissio2.logsUrl)) {
    return;
  }
  ...
  for (const {
    ...
    if (level === 'error') {
      ...
      _log().default.log(msgWithPrefix);
    }
  }
}
