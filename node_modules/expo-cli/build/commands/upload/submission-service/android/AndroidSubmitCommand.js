...
class AndroidSubmitCommand {
  static createContext(projectDir, commandOptions) {
    return {
      projectDir,
      commandOptions
    };
  ...
  async runAsync() {
    if (!(await _xdl().UserManager.getCurrentUserAsync())) {
  ...
  resolveAndroidPackageSource() {
    ...
    if ((_exp$android = exp.android) !== null && _exp$android !== void 0 && _exp$android.package) {
