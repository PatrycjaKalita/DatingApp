...
async function getBundledNativeModulesAsync(projectRoot, sdkVersion) {
  if (sdkVersion === 'UNVERSIONED') {
    ...
    try {
      ...
      _log().default.warn(`There seem to be a transient problem with Expo servers, using the cached dependency map (${_log().default.chalk.bold('bundledNativeModules.json')}) from the package "${_log().default.chalk.bold`expo`}" installed in your project.`);
