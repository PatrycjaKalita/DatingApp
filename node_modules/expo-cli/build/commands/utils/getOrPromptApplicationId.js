...
async function getOrPromptForBundleIdentifier(projectRoot) {
  ...
  _log().default.log(`${_log().default.chalk.bold(`📝  iOS Bundle Identifier`)} ${_log().default.chalk.dim((0, _TerminalLink().learnMore)('https://expo.fyi/bundle-identifier'))}`);
...
async function getOrPromptForPackage(projectRoot) {
  ...
  _log().default.log(`${_log().default.chalk.bold(`📝  Android package`)} ${_log().default.chalk.dim((0, _TerminalLink().learnMore)('https://expo.fyi/android-package'))}`);
