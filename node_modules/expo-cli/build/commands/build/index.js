...
function _default(program) {
  ...
  (0, _applyAsyncAction().applyAsyncActionProjectDir)(program.command('build:status [path]').alias('bs').helpGroup('build').option('--public-url <url>', 'The URL of an externally hosted manifest (for self-hosted apps).').description(`Get the status of the latest build for the project`), () => Promise.resolve().then(() => _interopRequireWildcard(require('./buildStatusAsync'))));
}
