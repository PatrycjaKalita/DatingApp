...
class IOSBuilder extends _BaseBuilder().default {
  ...
  maybeWarnDamagedSimulator() {
    ...
    if (isMacOsCatalinaOrLater && this.options.type === 'simulator') {
      ...
      _log().default.log(_chalk().default.bold(`🚨 If the build is not installable on your simulator because of "${_chalk().default.underline(`... is damaged and can't be opened.`)}", please run:`));
