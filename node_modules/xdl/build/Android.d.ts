...
export declare function getAdbFileOutputAsync(args: string[], encoding?: 'latin1'): Promise<Buffer>;
...
export declare function openProjectAsync({ projectRoot, shouldPrompt, devClient, device, scheme, }: {
    projectRoot: string;
 ...
 */
export declare function getAPKDirectory(projectRoot: string): string;
