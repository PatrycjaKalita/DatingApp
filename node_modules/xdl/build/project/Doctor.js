...
exports.FATAL = exports.ERROR = exports.WARNING = exports.NO_ISSUES = void 0;
...
async function _validateReactNativeVersionAsync(exp, pkg, projectRoot, sdkVersions, sdkVersion) {
  ...
  if (!/expo\/react-native/.test(reactNative)) {
    _internal2().ProjectUtils.logWarning(projectRoot, 'expo', `Warning: Not using the Expo fork of react-native. ${(0, _TerminalLink().learnMore)('https://docs.expo.dev/')}`, 'doctor-not-using-expo-fork');
