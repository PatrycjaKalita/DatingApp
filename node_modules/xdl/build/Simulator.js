...
async function openUrlInSimulatorSafeAsync({
  ...
  try {
    ...
    if (isDetached) {
      _internal().Logger.global.error(`Error running app. Have you installed the app already using Xcode? Since you are detached you must build manually. ${e.toString()}`);
    } else {
      _internal().Logger.global.error(e.message);
    }
